...
VENV_NAME="Agentic-Finance-Director-App_venv"
VENV_PATH="$VENV_BASE/$VENV_NAME"

echo "╔══════════════════════════════════════════════════════════════╗"
echo "║   AFDA — Python Virtual Environment Setup                   ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
...
CRUD_REQ="Services/afda-crud-api/requirements.txt"
GW_REQ="Services/afda-agent-gateway/requirements.txt"
